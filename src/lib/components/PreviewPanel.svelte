...
<div class="flex flex-col h-full">
	...
	<div class="flex-1 overflow-auto p-4">
		<div class="preview-stage bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] rounded-xl p-4 min-h-[200px] shadow-[inset_0_1px_3px_rgba(0,0,0,0.4),0_0_40px_rgba(15,52,96,0.15)] font-preview">
